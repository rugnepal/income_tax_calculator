...
total_taxable <- \(
  ...
  if (disab == F) {
    ...
    disab_wave <- ifelse(income >= 200000, 200000, income)
  }
  ...
  deduce <- rbind(
    list(names = "Total Income", val = income),
...
income_tax <- \(
  ...
  if (year == "2078/79" & ssf == 0 & mstatus == F & flancer == F) {
    slab <- single_2078_79
  } else if (year == "2078/79" & ssf != 0 & mstatus == F & flancer == F) {
    slab <- single_2078_79_ssf
  } else if (year == "2079/80" & ssf == 0 & mstatus == F & flancer == F) {
    slab <- single_2079_80
  } else if (year == "2079/80" & ssf != 0 & mstatus == F & flancer == F) {
    slab <- single_2079_80_ssf
  } else if (year == "2078/79" & ssf == 0 & mstatus & flancer == F) {
    slab <- couple_2078_79
  } else if (year == "2078/79" & ssf != 0 & mstatus & flancer == F) {
    slab <- couple_2078_79_ssf
  } else if (year == "2079/80" & ssf == 0 & mstatus & flancer == F) {
    slab <- single_2079_80
  } else if (year == "2079/80" & ssf != 0 & mstatus & flancer == F) {
    slab <- single_2079_80_ssf
  } else if (flancer) slab <- free_2079_80
